...
public class Terjual extends AppCompatActivity implements AdapterView.OnItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mManager = new LinearLayoutManager(Terjual.this, LinearLayoutManager.VERTICAL, false);
        mRecyclerview.setLayoutManager(mManager);
        mAdapter = new Adapter_terjual(Terjual.this, mItems);
    ...
    private void loadJson() {
        ...
        JsonArrayRequest reqData = new JsonArrayRequest(Request.Method.POST,
                "http://10.42.0.1/tiket/serverandroid/list_terjual.php", null,
                        ...
                        for (int i = 0; i < response.length(); i++) {
                            try {
                                ...
                                if (json_data.getString("data") == "kosong" || json_data.getString("data").equals("kosong")) {
                                    ...
                                    Model_terjual isidata = new Model_terjual();
                                    ...
                                    isidata.setEnkripsi(json_data.getString("enkripsi"));
